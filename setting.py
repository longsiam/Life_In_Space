...
class Setting:
	...
	def __init__(self):
		...
		self.star_density = 30    # 移动生成星星密度
		self.star_edge = 15       # 星星距窗口边框的距离(单位px)
		self.star_quantity = 55   # 一次性生成的星星数量
		self.star_darkest = 40    # 最暗的星星亮度
		self.star_lightest = 230  # 最亮的星星亮度 
		self.star_size = 2        # 星星尺寸(单位px) 
		self.fade_time = 0.2      # 淡入/淡出所需时间
		# 星星颜色RGB值表
		...
		# 起始CG换画面停顿时间
		self.scg_chgimg_time = (2,2.5,2.5,2.5,2.5,2.5,2.5,20,1.5,2.5)
